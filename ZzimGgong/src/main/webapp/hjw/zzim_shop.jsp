						...
						<div class="content">
							...
							<div class="shop_option_contain">
								<div class="shop_option">
									<input type="button"
										onclick="location.href='zzim_shop_func.jsp?resnum=${param.resnum}'"
										class="shop_option_a" id="option1" value="기능" disabled="true">
								</div>
								<div class="shop_option">
									<input type="button" onclick="location.href='zzim_shop_wating.html'"
										class="shop_option_a" id="option2" value="줄서기" disabled="true">
								</div>
								<div class="shop_option">
									<input type="button" onclick="location.href='zzim_shop_reserve.html'"
										class="shop_option_a" id="option3" value="예약" disabled="true">
								</div>
								<div class="shop_option">
